# `step-security/dsanders11-project-actions/copy-project`
...
Field values can be set on draft issues after the project is copied by adding an
HTML comment to the body of the issue with a JSON object mapping field names to
field values.
